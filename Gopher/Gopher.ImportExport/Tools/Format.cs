    ...
    public class Format
    {
        ...
        public static string ExportCustomerToString(Customer customer)
        {
            return string.Join(EXPORT_DELIMITER, new object[] {
                ...
                StringInQuotes(customer.TempoVisorData.Fillers),
                ...
                // TEMPO-VISOR DATA
                StringInQuotes(customer.EccubeData.CompanyName),
                customer.EccubeData.Fax,
                StringInQuotes(customer.EccubeData.Occupation),
